...
🟢 Phase A: Core Fundamentals (The Basics)
...
4. Label-Selector-Lab: Use a Python script to filter and list pods based on custom labels.
...
8. Config-Hot-Reloader: Write a Python "watcher" that detects when a ConfigMap changes and restarts the app logic.

🔵 Phase C: Resilience & Scheduling
...
🟣 Phase F: Scaling & Automation (Senior Level)
...
💎 Phase G: Extensibility (Platform Engineer Level)
...
🌐 Phase H: Platform Engineering & Developer Experience
...
🤖 Phase I: AIOps & Advanced Automation
...
🛡️ Phase J: Governance & Security (DevSecOps)
